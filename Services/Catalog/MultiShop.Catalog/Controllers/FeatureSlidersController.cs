...
namespace MultiShop.Catalog.Controllers
{
    ...
    {
        private readonly IFeatureSlidersService _featureSliderService;
        public FeatureSlidersController(IFeatureSlidersService featureSlidersService)
        {
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetByIdFeatureSliderAsync(string id)
        {
