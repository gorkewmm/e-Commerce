...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class ProductDetailController : Controller
    {
        ...
        [Route("UpdateProductDetail/{id}")]
        [HttpPost]
        public async Task<IActionResult> UpdateProductDetail(UpdateProductDetailDto _updateProductDetailDto)
        {
            var client = _httpClientFactory.CreateClient();

            var jsonData = JsonConvert.SerializeObject(_updateProductDetailDto);
